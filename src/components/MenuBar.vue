...
@layer utilities {
  ...
  .favorites {
    @apply absolute -left-6 -top-6 z-10 flex h-[calc(100%+48px)] w-4/5 -translate-y-[calc(100%+48px)] flex-col items-center gap-10 bg-gray-800 p-6 text-white shadow transition-all duration-300 ease-in-out sm:left-0 sm:top-0 sm:h-full sm:rounded-bl-xl sm:rounded-tl-xl sm:p-12;
  }
  ...
  .weather-informations {
    @apply mb-6 flex flex-col items-center justify-center gap-4 lg:flex-row lg:gap-0;
  }
  ...
  .details-left {
    @apply flex w-2/5 items-center justify-center;
  }
  ...
  .details-right {
    @apply flex w-3/5 flex-col justify-center gap-2;
  }
